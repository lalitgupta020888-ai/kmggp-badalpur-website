...
export const GALLERY_ALBUMS = [
  ...
  {
    slug: 'har-ghar-tiranga',
    title: 'Har Ghar Tiranga',
    icon: 'bi-flag-fill',
    description:
      'Independence Day at the Badalpur campus — the tricolour display board, the rangoli and the flag hoisting on 15 August 2026.',
    // An album may also carry one film. It leads the album page and is what the
    // site's welcome popup plays; `poster` is the still shown before it starts.
    video: {
      src: '/images/har-ghar-tiranga/college-kmggp.mp4',
      poster: '/images/har-ghar-tiranga/rangoli-display.jpg',
      caption: 'Har Ghar Tiranga at KMGGP Badalpur',
    },
    photos: [
      { src: '/images/har-ghar-tiranga/rangoli-display.jpg', caption: 'Tricolour Display Board and Rangoli' },
      { src: '/images/har-ghar-tiranga/staff-group-corridor.jpg', caption: 'Faculty and Staff at the Display Board' },
      { src: '/images/har-ghar-tiranga/staff-group-wide.jpg', caption: 'The Independence Day Gathering' },
      { src: '/images/har-ghar-tiranga/flag-hoisting-courtyard.jpg', caption: 'After the Flag Hoisting in the Courtyard' },
    ],
  },
  {
    slug: 'laboratories',
    title: 'Laboratories',
    icon: 'bi-cpu-fill',
    description: 'Computing, electronics and networking laboratories used across every branch.',
...
export const FEATURED_VIDEO_ALBUM = GALLERY_ALBUMS.find((album) => album.video) || null;
